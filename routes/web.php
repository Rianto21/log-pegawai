...
Route::get('/logout', [PegawaiController::class, 'logout'])->middleware('signed_pegawai')->name('logout');
...
Route::get('/log-harian/verifikasi/{id_log_harian}', [LogHarianController::class, 'log_harian_staff'])->middleware('signed_pegawai')->name('log_harian.verifikasi_view');
...
Route::post('/log-harian/verifikasi', [LogHarianController::class, 'verifikasi_log_harian'])->middleware('signed_pegawai')->name('log_harian.verifikasi_post');
